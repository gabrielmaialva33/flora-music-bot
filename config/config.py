...
EXTRA_PLUGINS_REPO = getenv(
    "EXTRA_PLUGINS_REPO",
    "https://github.com/gabrielmaialva33/flora-extra-plugin",
)
...
)  # Example:- https://t.me/mrootx
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/+BgpxMyJNjk5mYzhh"
)  # Example:- https://t.me/mrootchat

# Set it in True if you want to leave your assistant after a certain amount of time. [Set time via AUTO_LEAVE_ASSISTANT_TIME]
AUTO_LEAVING_ASSISTANT = is_bool(getenv("AUTO_LEAVING_ASSISTANT", "False"))

# Time after which you're an assistant account will leave chats automatically.
