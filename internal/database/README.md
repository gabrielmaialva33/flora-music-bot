# 💾 WinxMusic Database System

> **MongoDB-based Data Management for WinxMusic**
...
The **Database System** manages all persistent data for WinxMusic using MongoDB.
...
Typical document size is ~2KB for bot state and ~500B for chat settings. Standard operations are cached, providing
...
- **Help needed?** Join [Support Chat](https://t.me/WinxCallGroup)
- **Report bug?** [GitHub Issues](https://github.com/WinxCallChannel/flora-music-bot/issues)
