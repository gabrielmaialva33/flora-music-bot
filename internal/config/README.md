...
This document describes all configuration variables used in WinxMusic. These can be set as environment variables or in
...
| `SUPPORT_CHAT`    | `https://t.me/WinxCallGroup`   | **Full URL** to the support group.                    |
| `SUPPORT_CHANNEL` | `https://t.me/WinxCallChannel` | **Full URL** to the announcement channel.             |
